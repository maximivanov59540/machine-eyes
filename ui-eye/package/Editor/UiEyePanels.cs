...
namespace UiEye
{
    ...
    /// с поддельным источником данных, тема — игры. Образец регистрации — «probe», <c>Editor/Probe/UiEyeProbe.cs</c>.
    /// </para>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// Сборка только для редактора: ни реестр, ни «probe» в игру не попадают.
    /// </para>
    /// </remarks>
